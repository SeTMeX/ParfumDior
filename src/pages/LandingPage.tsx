import bk from '../assets/photo/landing-bk.jpg'
import Button from '../components/home/LandingButtons'
import '../index.css'

const LandingPage = () => {
    return (
        <div className="h-screen w-full bg-center bg-cover flex flex-row justify-between items-center font-playfair"
            style={{ backgroundImage: `url(${bk})` }}>
            <div className='flex flex-col text-center h-100vh w-50vh px-20'>
                <span className=' text-8xl text-gray-300 pb-2'>Products <br />
                    Luxorious</span>
