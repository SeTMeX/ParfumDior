        ...
        >
            ...
            <div className="flex items-center gap-3 px-8 sm:px-16 mb-6">
                <button
                    ...
                    className={`px-4 py-1.5 rounded-full border text-xs tracking-widest transition ${order === "ASC"
                ...
                <button
                    ...
                    className={`px-4 py-1.5 rounded-full border text-xs tracking-widest transition ${order === "DESC"
                            ? "border-blue-500 bg-blue-500/20 text-blue-300"
                            : "border-white/15 text-slate-500 hover:border-white/30"
                        }`}
                >
                ...
                >
                    {products.map((product, i) => (
                        <div
                            ...
                            style={{ background: "linear-gradient(135deg, #060d1f, #040810)" }}
                        >
                            <span className="text-[10px] text-[#1e3a6a] tracking-[3px] mb-2">
                                [{String((page - 1) * TAKE + i + 1).padStart(3, "0")}]
                            </span>
                            <h3 className="text-lg text-gray-200 font-light">{product.name}</h3>
                    ...
                    <div className="bg-gray-900 border border-white/10 rounded-2xl p-8 w-full max-w-md flex flex-col gap-5">
                        ...
                        {(
                            ...
                            <div key={key} className="flex flex-col gap-1">
                                <label className="text-sm text-gray-400 tracking-wider">{label}</label>
                                <input
                                    type={type}
                                    value={form[key]}
                                    onChange={(e) =>
