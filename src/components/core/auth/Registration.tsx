...
import { Drawer, DrawerContent, DrawerTitle, DrawerTrigger, DrawerClose, DrawerFooter } from "@/components/ui/drawer"
...
const RegisterForm = () => {
  ...
  const formContent = (className?: string) => (
      <div className={`w-full rounded-lg bg-gray-900 p-8 text-gray-100 shadow-lg ${className ?? ""}`}>
        ...
        <div className="flex justify-center gap-4">
          <button type="button" className="rounded-full p-3 bg-gray-800 hover:bg-gray-700 transition-colors" aria-label="Sign up with Google">
          ...
          <button type="button" className="rounded-full p-3 bg-gray-800 hover:bg-gray-700 transition-colors" aria-label="Sign up with Twitter/X">
            <svg viewBox="0 0 24 24" className="w-5 h-5 fill-white">
              <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
            </svg>
          </button>
          <button type="button" className="rounded-full p-3 bg-gray-800 hover:bg-gray-700 transition-colors" aria-label="Sign up with GitHub">
            <svg viewBox="0 0 24 24" className="w-5 h-5 fill-white">
        ...
        <p className="text-center text-sm mt-6 text-gray-400">
          ...
          <a href="#" className="text-blue-400 hover:text-blue-300 hover:underline">Sign in</a>
        </p>
      </div>
  )
  ...
  if (isDesktop) {
    return (
        <Dialog open={open} onOpenChange={setOpen}>
          ...
          <DialogContent className="p-0 border-none sm:max-w-[425px]" showCloseButton={false}>
  ...
  return (
      <Drawer open={open} onOpenChange={setOpen}>
        ...
        <DrawerContent className="bg-gray-900 border-gray-700">
          ...
          {formContent("rounded-b-none")}
          <DrawerFooter className="bg-gray-900 pt-0 pb-6">
            <DrawerClose asChild>
              <button className="w-full border border-gray-700 text-gray-400 hover:text-white hover:border-gray-500 transition-colors py-3 rounded-md font-semibold">
                Cancel
              </button>
            </DrawerClose>
          </DrawerFooter>
